...
UI_TRANSLATIONS = {
    ...
    "german": {
        ...
        "Offer screen": "Экран предложения",
        "In-progress screen": "Экран выполнения",
        "Turn-in screen": "Экран сдачи",
        ...
        "Permanent hostility": "Постоянная враждебность",
        "Threshold": "Порог",
        ...
        "Build talkable AI patrols": "Создание говорящих патрулей ИИ",
        "Patrols": "Патрули",
        ...
        "Everything found in the profile folder.": "Всё найденное в папке профиля.",
